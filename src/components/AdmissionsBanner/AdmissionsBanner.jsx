...
function AdmissionsBanner() {
  ...
  return (
    <section
      ...
      style={{ backgroundImage: `linear-gradient(180deg, rgba(15,27,82,0.55) 0%, rgba(15,27,82,0.72) 55%, rgba(15,27,82,0.92) 100%), url(${bgImage})` }}
    >
      <div className="container admissions__inner">
        ...
        <p className="admissions__text">
          Don&rsquo;t miss your chance to fly high. Reserve your seat today and start your aviation journey.
        </p>
        <div className="admissions__actions">
          <button type="button" className="btn btn-primary" onClick={openScholarship}>
            Apply Now
          </button>
          <a href="https://wa.me/919003480888" target="_blank" rel="noreferrer" className="btn btn-whatsapp">

    ...
    <section className="testimonials section">
      <div className="container">
        <div className="section-header">
          <span className="section-eyebrow testimonials__eyebrow">Student Success Stories</span>
          <h2 className="testimonials__heading">Student Success Stories</h2>
          <p className="testimonials__subheading">From classroom to cockpit cabin — hear it from our alumni.</p>
        </div>
          ...
          {TESTIMONIALS.map((item, idx) => (
            <div className="testimonial-card" key={item.name}>
              <div className="testimonial-card__top">
                ...
                <img src={AIRLINES[idx % AIRLINES.length]} alt="" className="testimonial-card__airline" loading="lazy" />
              </div>
              ...
              <div className="testimonial-card__footer">
                {AVATARS[item.avatarKey] ? (
                  <img src={AVATARS[item.avatarKey]} alt={item.name} className="testimonial-card__avatar" loading="lazy" />
                ) : (
              ...
              <div className="testimonial-card__salary">Salary: {item.salary}</div>
            </div>
          ))}

          <div className="video-card">
            <img src={videoThumb} alt="" aria-hidden="true" className="video-card__bg" loading="lazy" />
            <div className="video-card__scrim" />



            <button type="button" className="video-card__play" aria-label="Play success stories video">
            ...
            <div className="video-card__footer">
              <div className="video-card__avatars">
              </div>
              <h3 className="video-card__title">Watch Success Stories</h3>
              <p className="video-card__text">See how our alumni are flying high across the globe.</p>
            </div>
          </div>
        </div>
      </div>
